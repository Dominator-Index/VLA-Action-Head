...
class ConvexFlowActionHead(nn.Module):
    ...
    def _initialize_parameters(self):
        ...
        if hasattr(self.icnn, 'apply'):
            self.icnn.apply(self._init_icnn_weights)
        
        # Initialize input projection if exists
        if self.input_projection is not None:
            self.input_projection.apply(self._init_projection_weights)
        
        print("ConvexFlowActionHead parameters initialized")
    
    def _init_icnn_weights(self, module):
        """Initialize ICNN weights."""
    ...
    def _init_projection_weights(self, module):
